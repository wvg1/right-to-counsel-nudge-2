...
#create week 17 assignments
generate_assignments(start_id = 1099, n = 35, week = 17)

#create week 18 assignments
generate_assignments(start_id = 1134, n = 76, week = 18)

#create week 19 assignments
generate_assignments(start_id = 1210, n = 75, week = 19)

#create week 20 assignments
generate_assignments(start_id = 1285, n = 69, week = 20)

#create week 21 assignments
generate_assignments(start_id = 1354, n = 54, week = 21)

#create week 22 assignments
generate_assignments(start_id = 1408, n = 55, week = 22)

#create week 23 assignments
generate_assignments(start_id = 1463, n = 78, week = 23)

#create week 24 assignments
generate_assignments(start_id = 1541, n = 63, week = 24)

#create week 25 assignments
generate_assignments(start_id = 1604, n = 50, week = 25)

#create week 26 assignments
generate_assignments(start_id = 1654, n = 85, week = 26)
